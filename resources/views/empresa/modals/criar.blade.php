<div class="modal fade" tabindex="-1" role="dialog" id="dlgEmpresa">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content text-white bg-dark border-light">
            <form class="form-horizontal" id="formEmpresa" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control bg-dark text-white" id="nome" placeholder="Nome da Empresa">
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control bg-dark text-white" id="cnpj" data-mask="00.000.000/0000-00">
                            </div>
                            <span class='text-danger' id='cnpjError'></span>
                        </div>
                    </div>
